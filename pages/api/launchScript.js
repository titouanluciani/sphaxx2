        ...
        if(connectExist){
            ...
            const profileBtnInnerText = await page.evaluate(() => {
                try{
                    ...
                    const elBtn = page.click('.ml2.mr2.pv-s-profile-actions__overflow-toggle.artdeco-button.artdeco-button--circle.artdeco-button--muted.artdeco-button--2.artdeco-button--tertiary.artdeco-dropdown__trigger.artdeco-dropdown__trigger--placement-bottom.ember-view')
